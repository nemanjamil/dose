...
const imgFacebook = "https://www.figma.com/api/mcp/asset/5015dc98-6955-48fe-ac12-dac1c1b89dcd";
const imgInstagram = "https://www.figma.com/api/mcp/asset/6de0a337-1660-4c73-8fb0-ee51c69689d9";
const imgShopIcon = "https://www.figma.com/api/mcp/asset/759f0462-4809-42eb-a5fd-eea23413b947";

export default function TopBar() {
  return (
    <div className="absolute left-[375px] top-0 flex gap-[16px] items-center">
      {/* Facebook Icon */}
        ...
        <div className="flex gap-[24px] items-center">
          <div className="bg-[#ffe3d3] flex gap-[10px] items-center justify-center px-[11px] py-[10px] rounded-[14px] size-[46px] flex-shrink-0">
            <div className="relative size-[24px]">
              <img alt="Shop icon" className="w-full h-full" src={imgShopIcon} />
            </div>
          </div>
