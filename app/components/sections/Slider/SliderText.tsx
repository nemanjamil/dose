  ...
  return (
    <div className="flex flex-col gap-[24px] sm:gap-[32px] items-center md:items-start w-full lg:w-auto">
      ...
      <div className="flex flex-col gap-[12px] sm:gap-[16px] items-center md:items-start w-full">
        <h1 className="font-bold text-dose-dark text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] tracking-[-0.64px] sm:tracking-[-0.8px] md:tracking-[-0.96px] lg:tracking-[-1.12px] leading-[1.2] max-w-[300px] sm:max-w-[355px] text-center md:text-left">
          {title.map((line, idx) => (
