    ...
    <div className="relative w-full lg:w-auto h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] flex-shrink-0">
      ...
      <div className="absolute inset-0 shadow-[0px_20px_48px_0px_rgba(135,84,55,0.15)] rounded-[12px] sm:rounded-[16px] overflow-hidden bg-gradient-to-br from-green-300 to-green-500 flex items-center justify-center">
        <div className="text-center text-white">
          <p className="font-bold font-bold text-[24px] sm:text-[32px]">
            Product Image
          </p>
          <p className="font-medium font-medium text-[14px] sm:text-[16px] mt-[8px]">
            Placeholder - Add image from Figma
          </p>
          <p className="font-medium font-medium text-[12px] sm:text-[14px] mt-[12px] opacity-80">
        ...
        <div className="absolute top-[20px] left-[12px] sm:left-[24px] bg-white px-[12px] py-[8px] rounded-[99px] shadow-md">
          <p className="font-medium font-medium text-[12px] sm:text-[14px] text-dose-accent">
        ...
        <div className="absolute right-[16px] md:right-[32px] top-1/2 -translate-y-1/2 hidden sm:flex flex-col gap-[8px]">
          {[1, 2, 3].map((num) => (
            <div
              key={num}
              className={`flex items-center justify-center rounded-[99px] size-[40px] sm:size-[46px] font-semibold font-semibold text-[16px] sm:text-[20px] tracking-[-0.32px] sm:tracking-[-0.4px] ${
                num === 1 ? 'bg-white text-dose-accent' : 'bg-[rgba(255,255,255,0.4)] text-[rgba(167,37,59,0.4)]'
              }`}
            >
        ...
        <div className="absolute bottom-[12px] sm:bottom-[32px] left-[12px] sm:left-[32px] flex gap-[8px] sm:gap-[12px] items-center">
          <div className="h-[20px] sm:h-[24px] w-[80px] sm:w-[104px]">
            <div className="flex gap-[4px] h-full">
              ...
              <div className="w-[16px] sm:w-[20px] h-full rounded-full bg-dose-accent" />
              <div className="w-[16px] sm:w-[20px] h-full rounded-full bg-[#2c5aa0]" />
            </div>
          </div>
          <p className="font-medium font-medium text-white text-[13px] sm:text-[16px] md:text-[18px] tracking-[-0.26px] sm:tracking-[-0.32px] md:tracking-[-0.36px] whitespace-nowrap">
            14+ colors
          </p>
        </div>
      </div>
