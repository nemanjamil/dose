...
export default function PhoneAndEmail() {
  return (
    <section className="w-full mt-10">
      <div className="bg-dose-peach h-[40px] flex items-center justify-center">
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-[35px] items-center">
          {/* Email */}
          <div className="flex gap-3 items-center">
            ...
            <p className="font-medium text-dose-mid text-[12px] text-center tracking-[-0.24px] uppercase">
