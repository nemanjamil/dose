...
export default function CTAButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`bg-dose-accent flex gap-[16px] sm:gap-[24px] items-center pl-[8px] pr-[16px] sm:pr-[24px] py-[8px] rounded-[20px] shadow-[0px_10px_24px_0px_rgba(135,84,55,0.3)] hover:opacity-90 transition-opacity active:scale-95 w-full sm:w-auto justify-center sm:justify-start cursor-pointer ${className}`}
    >
